...
def run_force_alignment_STTScore(path_json,API_key,save_info_delete,save_info_notdelete,path_save_check_stt=None,path_remove_stt_score=None):
    path_save_check_stt = "/home/pdnguyen/VietAIbud500/Check_data_bud500/filter_data/STT_score/test/score_STT_get_data.json"
    path_remove_stt_score = "/home/pdnguyen/VietAIbud500/Check_data_bud500/filter_data/STT_score/test/score_STT_remove_data.json"
...
if __name__ == '__main__':
    ...
    path_json_test = "/home/pdnguyen/VietAIbud500/Bud500_convert/test/meta_data.json"
    path_save_info = "/home/pdnguyen/VietAIbud500/Check_data_bud500/filter_data/STT_score/test/data_score_less_65"

    check_score_audio,total_data = check_score(path_json=path_json_test,api_key=API_key,info_save_json=path_save_info)
    print(f"loại {check_score_audio} trong tổng số {total_data} data")

#     save_info_delete = "/home/pdnguyen/VietAIbud500/Check_data_bud500/filter_data/force_alignment/test/trim.json"
#     save_info_notdelete = "/home/pdnguyen/VietAIbud500/Check_data_bud500/filter_data/force_alignment/test/nottrim.json"
#     check_number_data = run_force_alignment_STTScore(path_json=path_json_test,API_key=API_key,save_info_delete=save_info_delete,save_info_notdelete=save_info_notdelete)
#     print("the total of data processing is",check_number_data)
